...
#the cells, we will now make the slightly dumb comparison of ASC vs B, to get to 
...
#As can be seen here, we are now watching this from the B-cell angle, i.e. CD138 is
#much downregulated. Therefore, we change the sign of the logFC values here. 
resMinus <- res
resMinus$table$logFC <- -resMinus$table$logFC

#So this is the result we are after. 
dir.create("Data/ASC_vs_B/AE")
saveRDS(resMinus, "Data/ASC_vs_B/AE/EdgeR_results.rds")
