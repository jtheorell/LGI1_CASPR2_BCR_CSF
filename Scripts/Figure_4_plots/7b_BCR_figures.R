...
BCR_H$V_gene_fam <- gsub("|-.+", "", BCR_H$V_CALL)
...
barGraphDat <- BCR_H_double[,c("Sample","Clonal", "light_type", "ISOTYPE", "CDR3_length",
                        "Specific", "Isoel", "Charge", "V_gene_fam", 
                        "All_mutations_H_L",
...
colsAndNames <- list(list("V_gene_fam", gray.colors(8, start =1, end = 0)[3:8]),
...
datSplit <- split(barGraphDat, barGraphDat$Sample)
...
#   1166_1    1227_1    1284_1       All 
#0.1139950 0.1822570 0.2211275 0.1238940 
...
#      1166_1       1227_1       1284_1          All 
#0.5666465422 0.1357142857 0.0006715205 0.0037115955 
...
#    1166_1     1227_1     1284_1        All 
#0.77325039 0.26153846 0.08660473 0.06269744 
...
focNames <- colnames(x)[grep("mutations|Charge|Isoel|CDR3", colnames(x))]
...
#       CDR3_length      Isoel     Charge All_mutations_H_L Non_silent_mutations_H_L CDR_mutations_H_L
#1166_1 0.051753850 0.17861656 0.11398432        0.02102681               0.02050094        0.01545805
#1227_1 0.490067552 0.24367848 0.57703051        0.39031778               0.35880660        0.26757532
#1284_1 0.105742080 0.00225387 0.00587588        0.71863067               0.34041269        0.27933354
#All    0.006062449 0.01933258 0.01662936        0.14464783               0.21095821        0.57918490
#       Non_silent_CDR_mutations_H_L All_mutations Non_silent_mutations CDR_mutations Non_silent_CDR_mutations
#1166_1                    0.1474349     0.2881002            0.9595261     0.6335600               0.28779656
#1227_1                    0.5807834     0.4271364            0.2141407     0.1760614               0.15406949
#1284_1                    0.1657060     0.8798416            0.5061666     0.5062490               0.32091814
#All                       0.9786757     0.4532041            0.8533768     0.7483219               0.09745026

#And here, the medians: 
sigFocNames <- colnames(x)[grep("Charge|Isoel|CDR3", colnames(x))]
