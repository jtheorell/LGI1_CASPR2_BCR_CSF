...
rawMSList <- lapply(list.files("../External/Data/MS_Ramesh_PBMC/Raw_PBMC_files", full.names = TRUE), 
                    fread)
...
fileNameList <- list.files("../External/Data/MS_Ramesh_PBMC/Raw_PBMC_files")
...
saveRDS(msSce, "../External/Data/MS_Ramesh_PBMC/0_raw.rds")
...
dir.create("Diagnostics/Comp_to_others/MS_Ramesh_PBMC", recursive = TRUE)
...
dev.copy(pdf,'Diagnostics/Comp_to_others/MS_Ramesh_PBMC/Exclusion_metrics_per_donor.pdf', height = 5, width = 18)
dev.off()

#2532  cells are excluded here. 
msSce <- msSce[,-which(msSce$discard)]
saveRDS(msSce, "../External/Data/MS_Ramesh_PBMC/1_lowQual_excluded.rds")
...
groupCode <- read.csv("../External/Data/MS_Ramesh_PBMC/Group_code.csv")
...
dir.create("Data/Comp_to_others/MS_Ramesh_PBMC", recursive = TRUE)
saveRDS(pred, "Data/Comp_to_others/MS_Ramesh_PBMC/MonacoSingler.rds")
unique(pred$pruned.labels)
#[1] "Th17 cells"                    "Central memory CD8 T cells"    "Effector memory CD8 T cells"  
#[4] "Classical monocytes"           "Natural killer cells"          "T regulatory cells"           
#[7] "Terminal effector CD8 T cells" "Non-Vd2 gd T cells"            "Follicular helper T cells"    
#[10] "Exhausted B cells"             "Naive CD4 T cells"             "MAIT cells"                   
#[13] "Th1/Th17 cells"                "Vd2 gd T cells"                "Terminal effector CD4 T cells"
#[16] "Th1 cells"                     "Intermediate monocytes"        "Naive B cells"                
#[19] "Naive CD8 T cells"             NA                              "Th2 cells"                    
#[22] "Switched memory B cells"       "Myeloid dendritic cells"       "Progenitor cells"             
#[25] "Non-switched memory B cells"   "Non classical monocytes"       "Plasmacytoid dendritic cells" 
#[28] "Plasmablasts"                  "Low-density basophils" 
...
saveRDS(msSceB, "../External/Data/MS_Ramesh_PBMC/2_normalised_post_monaco.rds")
...
#     ASC    B CD4T CD8T Myeloid Precursor
#ASC  100    0    0    0       0         0
#B     24 7184   22    1       7        49
...
saveRDS(msSceBRefined, "../External/Data/MS_Ramesh_PBMC/3_post_Kotliarov.rds")
